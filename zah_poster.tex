...
\usepackage[orientation=portrait,size=a0,scale=1.2]{beamerposterzah}
\usetheme{zah}
...
\newcommand{\myemail}{name@uni-heidelberg.de}
\newcommand{\myphone}{xxxx}
\newcommand{\myurlA}{\texttt{http://www.ita.uni-heidelberg.de/\~{}username/}} %careful with tildes!!
\newcommand{\myurlB}{http://www.google.com/}
{BEGIN:VCARD\?
VERSION:4.0\?
N:Doe;John;;;\?
FN:John\ M.\ Doe\?
...
ADR;HOME:;;Samplestr.\ 1;Heidelberg;;69115;Germany\?
ADR;WORK:;;Philosophenweg\ 12;Heidelberg;;69120;Germany\?
TEL;TYPE=cell:+49xxxyyyyyyy\?
TEL;TYPE=work,voice;PREF:+49622154xxxx\?
EMAIL;TYPE=work:doe@uni-heidelberg.de\?
EMAIL;TYPE=home:johnmdoe@gmail.com\?
IMPP;X-SERVICE-TYPE=Skype:johnny.doe\?
URL:http://www.johndoe.de\?
PHOTO;MEDIATYPE=image/jpeg:http://johndoe.de/photo.jpg\?
END:VCARD\?}
%----------------------------------------------------------------------------------------
%	TITLE SECTION 
%----------------------------------------------------------------------------------------

\title{\huge ACRONYM: Why We Believe Our Research Warrants Making a Large-Ass Poster} % Poster title

\author{phd student, random postdoc, bachelor student who did the plots, professor} % Author(s)

\institute{Zentrum f\"ur Astronomie der Universit\"at Heidelberg\\Astronomisches Rechen-Institut} % Institution(s)

%----------------------------------------------------------------------------------------
%	FOOTER TEXT
%----------------------------------------------------------------------------------------

\newcommand{\leftfoot}{Zentrum f\"ur Astronomie der Universit\"at Heidelberg} % Left footer text

\newcommand{\rightfoot}{\myemail} % Right footer text
...
\setbeamercolor{block title}{fg=UniRedOutline,bg=UniYellow} % Change the block title color
...
\begin{itemize}
\item Web: \myurlA
% Careful with the ol' tilde!
\item Email: \href{mailto:\myemail}{\myemail}
\item Phone: +49 (0)6221 54-\myphone
\end{itemize}
\end{column}
\begin{column}{0.2 \textwidth}
\begin{center}
	%\qrcode[height=0.7 \textwidth]{\myurlB}\\~\\
	%{Website}\\~\\
	\qrcode[height=0.6 \textwidth]{\myvcard}\\~\\vCard
\end{center}
\end{column}
